...
> Observer/event pattern implementation

[![PyPI version](https://badge.fury.io/py/py-observer.svg)](https://pypi.org/project/py-observer/)
...
# Basic usage
result = observer("your input here")
print(result)
```
...
result = observer("Hello World")

# Example 2: Batch processing
from py_observer import batch
